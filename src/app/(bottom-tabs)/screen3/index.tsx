...
const Item = ({ user, onUpdate, onDelete }: ItemProps) => {
    ...
    const handleSave = async () => {
        try {
            const updatedData = { name, city, avatar };
        ...
        <View style={styles.itemContainer}>
            <TouchableOpacity onPress={() => setDetailModalVisible(true)}>
                <View style={styles.contentContainer}>
                    ...
                    <Text style={styles.itemText}>Ngày sinh: {user.city}</Text>
                </View>
            </TouchableOpacity>
            ...
            <Modal visible={detailModalVisible} animationType="slide" transparent>
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        ...
                        <Text style={styles.detailText}>Ngày sinh: {user.city}</Text>
                        <TouchableOpacity
...
const HomeScreen = () => {
    ...
    const addUser = async () => {
        ...
        if (!newcity.match(/^\d{4}-\d{2}-\d{2}$/)) {
            Alert.alert('Ngày sinh không hợp lệ. Định dạng đúng: YYYY-MM-DD');
            return;
        }

        try {
            const newUser = { name: newName, city: newcity, avatar: newAvatar };
